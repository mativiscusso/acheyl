        ...
        <div id="carouselProducto" class="carousel-cell">
            ...
            <div class="card" style="width: 18rem;text-align:center;">
                ...
                <div class="card-body" style="display:flex; flex-direction:column;height:30vh;justify-content: space-between; ">
                    ...
                    <h5 class="card-title">ESENCIAS PARA ELÉCTRICOS</h5>

                    <p class="card-text">Amplia variedad de fragancias</p>
        ...
        <div id="carouselProducto" class="carousel-cell">
            ...
            <div class="card" style="width: 18rem;text-align:center;">
                ...
                <div class="card-body" style="display:flex; flex-direction:column;height:30vh;justify-content: space-between">
                    ...
                    <p class="card-text">Alcohol en Gel, Jabon Liquido, Papel, Toallas, Fragancias</p>
