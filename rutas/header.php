...
<header class="sticky-top">
        <nav id="barraMenu" class="navbar navbar-expand-lg navbar-light p-2 mb-3 bg-white rounded">
            <a id="logo" class="navbar-brand animated pulse delay-1s" href="index2"><img class="logo img-fluid" src="img/acheyl_logo.png" alt=""></a>
...
<!--                     <li class="nav-item dropdown">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../rutas/espmedicas">PRODUCTOS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../rutas/promociones">SERVICIOS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../rutas/faqs">FRANQUICIAS</a>
                    </li>
                    <li class="nav-item">
